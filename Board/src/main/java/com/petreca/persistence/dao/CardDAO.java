...
import com.petreca.dto.CardDetailsDTO;
...
import static com.petreca.persistence.converter.OffSetDateTimeConverter.toOffsetDateTime;
...
public class CardDAO {
    ...
    public CardEntity insert(final CardEntity entity) throws SQLException {
        ...
        try (var statement = connection.prepareStatement(sql)) {
            ...
            if (statement instanceof com.mysql.cj.jdbc.StatementImpl impl) {
